    ...
    <div class="max-w-6xl mx-auto px-4 py-8">
        ...
        @elseif($page == 'baca')
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="lg:col-span-2 bg-amber-50/40 border border-amber-100 rounded-xl p-8 shadow-sm">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <form action="{{ route('reader.review.store', $naskah['id']) }}" method="POST" class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="rating" class="w-full bg-gray-50 border border-gray-300 rounded-md px-3 py-2 focus:ring-blue-500 focus:border-blue-500" required>
