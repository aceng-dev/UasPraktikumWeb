...
<div class="layout">
    ...
    <main class="main">
        ...
        <div class="stats-row">
            <div class="stat-card">
                <div class="stat-label">Total Naskah</div>
            ...
            <div class="stat-card">
                <div class="stat-label">Penulis Mitra</div>
                <div class="stat-value">0</div>
            </div>
            <div class="stat-card">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="#" class="btn btn-primary">+ Tambah Naskah</a>
            </div>
            <div class="card-body">
                <div class="empty-state">
                    <div class="icon">📝</div>
                    <h3>Belum ada naskah</h3>
                    <p>Mulai dengan menambahkan naskah pertama Anda untuk publikasi</p>
                    <a href="#" class="btn btn-primary">Tambah Naskah</a>
                </div>
            </div>
        </div>
