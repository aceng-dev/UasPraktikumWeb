...
<head>
    ...
    <title>Publisher Dashboard — AnoKind</title>
...
<div class="layout">
    <aside class="sidebar">
        <div class="sb-brand">
            ...
            <span class="sb-role">Publisher</span>
        </div>
        <nav class="sb-nav">
            ...
            <a href="#" class="nav-item"><span class="nav-icon">🏷️</span><span>Katalog</span></a>
            <a href="#" class="nav-item"><span class="nav-icon">💰</span><span>Keuangan</span></a>
        </nav>
        <div class="sb-footer">
    ...
    <main class="main">
        <div class="page-header">
            ...
            <p>Kelola penerbitan dan distribusi karya sastra berkualitas</p>
        </div>
        ...
        <div class="stats-row">
            <div class="stat-card"><div class="stat-label">Total Naskah</div><div class="stat-value">0</div></div>
            <div class="stat-card"><div class="stat-label">Kategori</div><div class="stat-value">0</div></div>
            <div class="stat-card"><div class="stat-label">Penulis Mitra</div><div class="stat-value">0</div></div>
            <div class="stat-card"><div class="stat-label">Pendapatan</div><div class="stat-value">Rp 0</div></div>
        </div>

        <div class="card">
            <div class="card-header">
                <h2>Naskah Terbaru</h2>
                <a href="#" class="btn btn-amber">+ Tambah Naskah</a>
            </div>
            <div class="card-body">
                <div class="empty-state">
                    <div class="icon">📝</div>
                    <h3>Belum ada naskah</h3>
                    <p>Mulai dengan menambahkan naskah pertama untuk publikasi</p>
                    <a href="#" class="btn btn-amber">Tambah Naskah</a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header"><h2>Mitra Penulis</h2></div>
            <div class="card-body">
                <div class="empty-state">
                    <div class="icon">👥</div>
                    <h3>Belum ada mitra</h3>
                    <p>Kolaborasi dengan penulis untuk memperluas koleksi naskah</p>
                </div>
            </div>
        </div>
    </main>
